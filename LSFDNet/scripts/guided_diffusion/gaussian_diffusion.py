...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        #                                          betas=betas,
        #                                          dynamic_threshold=False,#dynamic_threshold,
    ...
    def p_sample_loop_progressive(
        ...
        for i in indices:
            ...
            with th.no_grad():
                ...
                # if i%50 ==0:
                #     img1 = img.detach_()
                #     temp_img= img1.detach().cpu().squeeze().numpy()
                ...
                #     file_path = '/home/gyy/0fusion/exp_vis/recon'
                #     imsave(os.path.join(file_path, "{}.png".format(f"x_{t_test}_{str(i).zfill(4)}")),temp_img)
